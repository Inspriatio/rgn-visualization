...
# 开始提取距离矩阵
# 遍历文件夹下所有文件
path="C:/Users/xuyang/Desktop/1/ProcessNewPDB"
...
for b in range(len(FName)):
    os.mkdir('C:/Users/xuyang/Desktop/1/Three_Angel/'+FName[b])
for a in range(len(FName)):
    ...
    # print(len(angel))
    # print(len(angel[0]))
    with open("C:/Users/xuyang/Desktop/1/Three_Angel/"+FName[a]+"/"+FName[a]+"_NEW_Angel.json",
              "w") as f:
        json.dump(angel, f)
